...
export function Footer() {
  return (
    <div className="relative">
      <Container>
        <div className="grid max-w-screen-xl grid-cols-1 gap-10 pt-12 mx-auto mt-10 border-t border-gray-100 dark:border-trueGray-700 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2">
              <img
                ...
                className="w-8"
              />
              <span className="text-3xl font-medium text-green-500 dark:text-gray-100">Search</span>
            </div>

            <div className="max-w-md mt-4 text-lg text-gray-500 dark:text-gray-400">
          ...
          <div className="lg:col-span-1 flex flex-col items-end">
            <div className="text-lg">Suivez nous</div>
        ...
        <div className="mt-6 text-sm text-center text-gray-600 dark:text-gray-400">
          Copyright © {new Date().getFullYear()}. SAIRCH
        </div>
      </Container>
    </div>
  );
